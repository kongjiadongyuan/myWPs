...
enum opt_code
{
  ...
  OPT_list = 1674,                           /* -list */
  OPT_m128bit_long_double = 1675,            /* -m128bit-long-double */
  OPT_m16 = 1676,                            /* -m16 */
  OPT_m32 = 1677,                            /* -m32 */
  OPT_m3dnow = 1678,                         /* -m3dnow */
  OPT_m3dnowa = 1679,                        /* -m3dnowa */
  OPT_m64 = 1680,                            /* -m64 */
  OPT_m80387 = 1681,                         /* -m80387 */
  OPT_m8bit_idiv = 1682,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1683,             /* -m96bit-long-double */
  OPT_mabi_ = 1684,                          /* -mabi= */
  OPT_mabm = 1685,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1686,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1687,                 /* -maddress-mode= */
  OPT_madx = 1688,                           /* -madx */
  OPT_maes = 1689,                           /* -maes */
  OPT_malign_data_ = 1690,                   /* -malign-data= */
  OPT_malign_double = 1691,                  /* -malign-double */
  OPT_malign_functions_ = 1692,              /* -malign-functions= */
  OPT_malign_jumps_ = 1693,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1694,                  /* -malign-loops= */
  OPT_malign_stringops = 1695,               /* -malign-stringops */
  OPT_mamx_bf16 = 1696,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1697,                      /* -mamx-int8 */
  OPT_mamx_tile = 1698,                      /* -mamx-tile */
